...
import com.deepblue.h2echo.annotations.EnableH2Echo;
import com.deepblue.h2echo.dialects.*;
...
public class H2Echo {
   ...
   */
  public static void echoDaosOnObject(
    ...
    dialectRunner.runFlywayScriptsOnH2(jdbcTemplate, fileListSorted, displayLog);
  }

  public static void echoDaosOnObject(
          JdbcTemplate jdbcTemplate, ScriptSyntax syntax, boolean displayLog) {
    echoDaosOnObject(jdbcTemplate, DEFAULT_SCRIPT_PATH, syntax, displayLog);
  }

  public static void echoDaosOnObject(JdbcTemplate jdbcTemplate, boolean displayLog) {
    echoDaosOnObject(jdbcTemplate, DEFAULT_SCRIPT_PATH, ScriptSyntax.MARIA_DB, displayLog);
  }

  public static void echoDaosOnObject(JdbcTemplate jdbcTemplate, String scriptPath, boolean displayLog) {
    echoDaosOnObject(jdbcTemplate, scriptPath, ScriptSyntax.MARIA_DB, displayLog);
  }
   ...
   * annotated with @EchoDao, and executes Flyway migration scripts.
   *
    ...
    for (Field field : object.getClass().getDeclaredFields()) {
      if (field.isAnnotationPresent(EchoDao.class)) {
        ...
        try {
          ...
          // Run the Flyway scripts.
          echoDaosOnObject(jdbcTemplate, scriptSyntax, displayLog);
        }
